...
- `2026-03-23 | Codex | Adapted the template governance model for the Searcharr lineage`
- `2026-04-29 | Codex | Updated project identity references for Curatarr`
...
- define the tracked documentation-governance model for Curatarr
...
- the Curatarr architecture and reference-lineage docs in `documentation/`
